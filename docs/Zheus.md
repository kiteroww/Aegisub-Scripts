...
Zheus uses DependencyControl only to check and install updates to its own script. It declares no additional required modules. Existing color-manager and accessibility settings remain local in the Aegisub user directory.
