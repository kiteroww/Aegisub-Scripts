...
- `Join Overlaps` joins selected overlapping groups and keeps source texts separated by `\N`.
- Cue Timer can auto-search timing-analysis files when the dialog opens, or leave path boxes untouched when disabled.
