...
TagOps.actions = {"Adjust tags", "In-Out tags", "Pos Align"}
...
______________
   ...
   5.7. Drop R: removes the rescale clip.
   5.8. Center: recenters after a clip-based rescale.
   5.9. The Text, Border, Shadow, Blur, and fsp checkboxes define which
...
___________
   ...
   10.1. Copy Tags button: copies the checked tags by Effect group. If
         ...
         - Append to first block: adds the tags to the first existing
           block.
   10.2. Keep Only button: removes all override tags except the checked
         tags from the selected lines.
   10.3. Adjust tags: adds (Add) or scales (Percent) auto-detected
         numeric tags. Checking an auto-detected tag excludes it;
         checking a manual-only tag adds it to the adjustment.
   10.4. In-Out tags: with two lines selected, generates a single line
         with the timed transition and comments the originals.
   10.5. Pos Align: uses the first two selected lines as fixed roles:
   ...
   10.6. Show result: prints a summary of modified lines and tags.
...
5. PERSPECTIVA
   ...
   5.7. Drop R: elimina el clip de reescalado.
   5.8. Center: recentra después de un reescalado por clip.
   5.9. Casillas Texto, Borde, Sombra, Blur y fsp: definen qué
...
10. TAG OPS
   ...
   10.1. Boton Copiar tags: copia los tags marcados por grupo de Effect.
         ...
         dialogo seleccionada se usa como fuente para las demas lineas.
          ...
          Anexar en primer bloque: añade los tags al primer bloque
           existente.
   10.2. Botón Keep Only: elimina todos los tags de override excepto
         los tags marcados en las líneas seleccionadas.
   10.3. Ajustar tags (Adjust tags): suma (Add) o escala (Percent) los
         tags numéricos detectados. Marcar un tag ya detectado lo excluye;
         marcar un tag manual lo añade al ajuste.
   10.4. InOut tags: con dos líneas seleccionadas genera una sola
         línea con la transición temporizada y comenta las originales.
   10.5. Pos Align: usa las dos primeras lineas seleccionadas como
   ...
   10.6. Mostrar resultado: imprime un resumen de líneas y tags
         modificados.
...
______________
   ...
   5.7. Drop R: remove o clip de redimensionamento.
   5.8. Center: recentraliza após um redimensionamento por clip.
   5.9. As caixas Texto, Borda, Sombra, Blur e fsp definem quais
...
___________
   ...
   10.1. Botao Copiar tags: copia as tags marcadas por grupo de Effect.
         ...
         - Anexar no primeiro bloco: adiciona as tags ao primeiro bloco
           existente.
   10.2. Botao Keep Only: remove todas as tags de override exceto as
         tags marcadas nas linhas selecionadas.
   10.3. Ajustar tags (Adjust tags): soma (Add) ou escala (Percent) as
         tags numéricas detectadas. Marcar uma tag detectada a exclui;
         marcar uma tag manual a adiciona ao ajuste.
   10.4. In-Out tags: com duas linhas selecionadas, gera uma única linha
         com a transição temporizada e comenta as originais.
   10.5. Pos Align: usa as duas primeiras linhas selecionadas como
   ...
   10.6. Mostrar resultado: imprime um resumo das linhas e tags
         modificadas.
...
local function row_master_gui(subs, sel)
    ...
    while true do
        ...
        local d = {
            ...
            { class="checkbox", name="pk_remove_clip", label=L("lbl_drop_r"), value=state.pk_remove_clip, x=7, y=14, width=1, height=1 },
